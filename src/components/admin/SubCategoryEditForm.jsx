...
const SubCategoryEditForm = ({id, categoryId, subCategory}) => {
    ...
    let data = categories.filter((category) => category.id === categoryId)[0];
                ...
                <div className="rg-select-inner  ">
                    <select
                        ...
                        {categories.map((category) =>(
                          <option value={category.id} key={category.id} selected={category?.id === categoryId}>{category.name}</option>     
                        ))}
