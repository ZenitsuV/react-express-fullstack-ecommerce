...
const CategoryEditForm = ({id}) => {
    ...
    let data = categories.filter((category) => category.id === id)[0];
          ...
          <span className="register-wrap register-half">
                ...
                <div>
                    <input
                            ...
                            type="text"
                            value={isEdit ? data?.name:formData.categoryName}
                            id="categoryName"
                            name="categoryName"
            ...
            <span className="register-wrap register-half">
                ...
                <div>
                    <input
                            ...
                            type="text"
                            value={isEdit ? data?.icon:formData.iconName}
                            id="iconName"
                            name="iconName"
                            onChange={handleChange}
                        />
            ...
            <span className="register-wrap register-half" style={{marginTop: "2px"}}>
                ...
                <div>
                    <input
                            ...
                            type="color"
                            value={isEdit ? data?.bgcolor:formData.color}
                            name="color"
                            id="color"
                            onChange={handleChange}
                        />
            ...
            <span className="register-wrap register-btn" style={{marginTop: "10px", justifyContent:'end'}}>            
                <button className="btn-1" type="submit" >Update</button></span>
        </form>   
