        ...
        <span className="register-wrap register-half">
            ...
            <div>
                <input
                        ...
                        type="text"
                        value={isEdit ? data?.name:formData.productName}
                        id="productName"
                        name="productName"
            ...
            <span className="register-wrap register-half">
                ...
                <div>
                    <input
                            ...
                            type="text"
                            value={isEdit ? data?.title:formData.title}
                            name="title"
                            id="title"
                            onChange={handleChange}
                        />
            ...
            <span className="register-wrap register-half" style={{marginTop: "10px"}}>
                ...
                <div>
                    <input
                        ...
                        type="number"
                        min='1'
                        value={isEdit ? data?.price:formData.price}
                        name="price"
                        onChange={handleChange}
                        />
            ...
            <span className="register-wrap register-half" style={{marginTop: "10px"}}>
                ...
                <div>
                    <input
                        ...
                        type="number"
                        min='1'
                        value={isEdit ? data?.discountPrice:formData.discountPrice}
                        name="discountPrice"
                        onChange={handleChange}
                        />
            ...
            <span className="register-wrap" style={{marginTop: "10px"}}>
                ...
                <div>
                    <input
                        ...
                        type="text"
                        value={isEdit ? data?.description:formData.description}
                        name="description"
                        style={{width:"97%"}}
                        onChange={handleChange}
                        />
            ...
            <span className="register-wrap" style={{marginTop: "10px"}}>
                ...
                <div className='pro-image' style={{marginTop: "10px"}}>
                   <img src={data?.images} style={{width: "275px",height: "200px", border:"1px solid #e5e5e5"}}/>
                </div>
            </span>   
            ...
            <span className="register-wrap register-half" style={{marginTop: "10px"}}>
                ...
                <div>
                    <input
                        ...
                        min='1'
                        step='1'
                        value={isEdit ? data?.stock:formData.stock}
                        name="stock"
                        onChange={handleChange}
                        />
